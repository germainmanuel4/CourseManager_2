...
Public Class _ViewReportStudent
    ...
    Protected Sub SearchButton_Click(sender As Object, e As EventArgs) Handles SearchButton.Click
        ...
        Dim command As New SqlCommand("Select * from Results where student_id = @student_id", connection)
        command.Parameters.Add("@student_id", SqlDbType.VarChar).Value = SearchBox.Text
        ...
        command2.Parameters.Add("@event_description", SqlDbType.VarChar).Value = "Viewed Reports For Students " + SearchBox.Text
